...
const chartData = [
	{ month: "January", detected: 250 },
	{ month: "February", detected: 135 },
	{ month: "March", detected: 78 },
	{ month: "April", detected: 128 },
	{ month: "May", detected: 19 },
	{ month: "June", detected: 26 },
];
const chartConfig = {
	detected: {
		label: "Detected",
				...
				<CardFooter className="flex flex-col sm:flex-row items-center justify-between px-4 py-2 rounded-b-lg">
					<div className="flex flex-col items-center sm:items-start">
						<p className="text-sm font-medium text-gray-700">
							Total Detected Cyber Bullying Replies All Time
						</p>
					...
					<div className="flex flex-col items-center sm:items-end">
						<p className="text-sm font-medium text-gray-700">
							Total Dectected Cyber Bullying Replies This Month
						</p>
						<p className="text-lg font-bold text-gray-900">
